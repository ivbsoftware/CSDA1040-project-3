...
```{r fig12, fig.width=5.5, fig.cap="Hierarhical clustering of syntetic time series using DTW distances"}
library(dtw)
...
```{r fig13, fig.width=5.5, fig.cap="Hierarhical clustering of syntetic time series using Euclidean distances"}
myDist <- dist(sample2)
...
## KNN model - Find the k nearest neighbours 
